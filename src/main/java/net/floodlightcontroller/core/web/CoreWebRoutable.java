...
import net.floodlightcontroller.flatfilerecord.web.SwitchAggPortsFFRecordResource;
...
public class CoreWebRoutable implements RestletRoutable {
	...
	public Restlet getRestlet(Context context) {
		...
		// web uri for controller general information
		router.attach("/controller/info/json", ControllerInfoResource.class);
		// web uri for aggregate port stats record
		router.attach(
				"/switch/{switchId}/ffrecord/aggports/{lastRecords}/json",
				SwitchAggPortsFFRecordResource.class);
